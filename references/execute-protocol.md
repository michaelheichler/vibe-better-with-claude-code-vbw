...
3. Follow the shared contract orchestrator response procedure, including its maximum of three `shutdown_request` attempts per teammate and residual-cleanup fallback for any sequence of plain-text or rejected responses.
