...
SKILL_DIR="$ROOT/.agents/skills/vbw-review-contributor-pr"
SKILL="$SKILL_DIR/SKILL.md"
REFERENCE="$SKILL_DIR/references/github-review-submission.md"
QA_REFERENCE="$SKILL_DIR/references/qa-evidence-comments.md"
